...
module DataCache (
  ...
  assign _zz_29 = (stageB_mmuRsp_physicalAddress[10 : 5] != 6'h3f);
  ...
  assign ways_0_tagsReadRsp_address = _zz_6[22 : 2];
  ...
  assign ways_1_tagsReadRsp_address = _zz_9[22 : 2];
  ...
  assign _zz_12 = (io_cpu_execute_address[10 : 2] >>> 0);
  ...
  always @ (*) begin
    _zz_14[0] = ((io_cpu_memory_mmuRsp_physicalAddress[31 : 11] == ways_0_tagsReadRsp_address) && ways_0_tagsReadRsp_valid);
    _zz_14[1] = ((io_cpu_memory_mmuRsp_physicalAddress[31 : 11] == ways_1_tagsReadRsp_address) && ways_1_tagsReadRsp_valid);
  end

  assign stageA_wayHits = _zz_14;
  assign _zz_16 = (io_cpu_memory_address[10 : 2] >>> 0);
...
module InstructionCache (
  ...
  assign _zz_22 = (! lineLoader_flushCounter[6]);
  ...
  assign fetchStage_read_waysValues_0_tag_address = _zz_12[22 : 2];
  assign _zz_13 = io_cpu_prefetch_pc[10 : 5];
  ...
  assign fetchStage_read_waysValues_1_tag_address = _zz_15[22 : 2];
