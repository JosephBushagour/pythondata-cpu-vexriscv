...
module InstructionCache (
  ...
  assign _zz_42 = (! lineLoader_flushCounter[6]);
  assign _zz_43 = (lineLoader_flushPending && (! (lineLoader_valid || io_cpu_fetch_isValid)));
  assign _zz_44 = lineLoader_wayToAllocate_willIncrement;
  assign _zz_45 = {1'd0, _zz_44};
  assign _zz_46 = _zz_20[0 : 0];
  assign _zz_47 = _zz_20[1 : 1];
  assign _zz_48 = _zz_23[0 : 0];
  assign _zz_49 = _zz_23[1 : 1];
  assign _zz_50 = _zz_26[0 : 0];
  assign _zz_51 = _zz_26[1 : 1];
  assign _zz_52 = _zz_29[0 : 0];
  assign _zz_53 = _zz_29[1 : 1];
  assign _zz_54 = {lineLoader_write_tag_0_payload_data_address,{lineLoader_write_tag_0_payload_data_error,lineLoader_write_tag_0_payload_data_valid}};
  assign _zz_55 = {lineLoader_write_tag_1_payload_data_address,{lineLoader_write_tag_1_payload_data_error,lineLoader_write_tag_1_payload_data_valid}};
  assign _zz_56 = {lineLoader_write_tag_2_payload_data_address,{lineLoader_write_tag_2_payload_data_error,lineLoader_write_tag_2_payload_data_valid}};
  assign _zz_57 = {lineLoader_write_tag_3_payload_data_address,{lineLoader_write_tag_3_payload_data_error,lineLoader_write_tag_3_payload_data_valid}};
  always @ (posedge clk) begin
    if(_zz_4) begin
  ...
  always @ (posedge clk) begin
    if(_zz_17) begin
      _zz_35 <= banks_3[_zz_16];
    end
  end

  always @ (posedge clk) begin
    if(_zz_8) begin
      ways_0_tags[lineLoader_write_tag_0_payload_address] <= _zz_54;
    end
  end

  always @ (posedge clk) begin
    if(_zz_19) begin
      _zz_36 <= ways_0_tags[_zz_18];
    end
  end

  always @ (posedge clk) begin
    if(_zz_7) begin
      ways_1_tags[lineLoader_write_tag_1_payload_address] <= _zz_55;
    end
  end

  always @ (posedge clk) begin
    if(_zz_22) begin
      _zz_37 <= ways_1_tags[_zz_21];
    end
  end

  always @ (posedge clk) begin
    if(_zz_6) begin
      ways_2_tags[lineLoader_write_tag_2_payload_address] <= _zz_56;
    end
  end

  always @ (posedge clk) begin
    if(_zz_25) begin
      _zz_38 <= ways_2_tags[_zz_24];
    end
  end

  always @ (posedge clk) begin
    if(_zz_5) begin
      ways_3_tags[lineLoader_write_tag_3_payload_address] <= _zz_57;
    end
  end

  always @ (posedge clk) begin
    if(_zz_28) begin
      _zz_39 <= ways_3_tags[_zz_27];
    end
  end
  ...
  always @(*) begin
    case(fetchStage_hit_wayId)
      2'b00 : begin
        _zz_40 = fetchStage_read_waysValues_0_tag_error;
        _zz_41 = fetchStage_read_banksValue_0_data;
      end
      2'b01 : begin
        _zz_40 = fetchStage_read_waysValues_1_tag_error;
        _zz_41 = fetchStage_read_banksValue_1_data;
      end
      2'b10 : begin
        _zz_40 = fetchStage_read_waysValues_2_tag_error;
        _zz_41 = fetchStage_read_banksValue_2_data;
      end
      default : begin
        _zz_40 = fetchStage_read_waysValues_3_tag_error;
        _zz_41 = fetchStage_read_banksValue_3_data;
      end
    endcase
  end
  ...
  always @ (*) begin
    lineLoader_wayToAllocate_valueNext = (lineLoader_wayToAllocate_value + _zz_45);
  ...
  assign fetchStage_read_banksValue_3_dataMem = _zz_35;
  ...
  assign _zz_20 = _zz_36;
  assign fetchStage_read_waysValues_0_tag_valid = _zz_46[0];
  assign fetchStage_read_waysValues_0_tag_error = _zz_47[0];
  ...
  assign _zz_23 = _zz_37;
  assign fetchStage_read_waysValues_1_tag_valid = _zz_48[0];
  assign fetchStage_read_waysValues_1_tag_error = _zz_49[0];
  ...
  assign fetchStage_read_waysValues_2_tag_valid = _zz_50[0];
  assign fetchStage_read_waysValues_2_tag_error = _zz_51[0];
  ...
  assign _zz_29 = _zz_39;
  assign fetchStage_read_waysValues_3_tag_valid = _zz_52[0];
  assign fetchStage_read_waysValues_3_tag_error = _zz_53[0];
  ...
  assign fetchStage_hit_error = _zz_40;
  assign fetchStage_hit_data = _zz_41;
